...
const apiData = [
    {
      ...
      "profile": {
        ...
        "contact": "Novo Alle 1\u003Cbr\u003EBagsvaerd 2880\u003Cbr\u003EDenmark\u003Cbr\u003E\u003Ca href=\"tel:4544448888\" class=\"C($linkColor)\"\u003E45 44 44 88 88\u003C/a\u003E\u003Cbr\u003E\u003Ca href=\"https://www.novonordisk.com\" rel=\"noopener noreferrer\" target=\"_blank\" class=\"C($linkColor)\" title=\"\"\u003Ehttps://www.novonordisk.com\u003C/a\u003E"
      }
    },
    {
      "profitability": {
        "profitMargin": "36.03%",
        "operatingMargin": "42.79%"
      },
      "is": {
        "revenue": "232.26B",
        "revenuePerShare": "51.81"
      }
    }
  ]
...
module.exports = {
    ...
    //         method: "GET",
    //         url: "https://finance.yahoo.com/quote/"+symbol+"?.neo_opt=0",
    //         headers: {
    ...
    //     })
        ...
        //     method: "GET",
        //     url: "https://finance.yahoo.com/quote/"+symbol+"/analysis?.neo_opt=0",
        //     headers: {
        //         "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 Safari/537.36"
        //     }
        // })
        ...
        //     method: "GET",
        //     url: "https://finance.yahoo.com/quote/"+symbol+"/profile?.neo_opt=0",
        //     headers: {
        //         "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 Safari/537.36"
        //     }
        // })
        ...
        // const targetSelector11 = '#Col1-0-Profile-Proxy > section > div.asset-profile-container > div > div > p.D\\(ib\\).Va\\(t\\) > span:nth-child(5)';

        // const targetSelector12 = '#Col1-0-Profile-Proxy > section > div.asset-profile-container > div > div > p.D\\(ib\\).W\\(47\\.727\\%\\).Pend\\(40px\\)';


        // stockInfo.profile = {
            
        //     employees: parseFloat($3(targetSelector10).text().replace(",","")),
        //     industry: $3(targetSelector11).text(),
        //     contact: $3(targetSelector12).html(),
        // }
    ...
    getStaticstics: async function (symbol) {
        const axiosResponse = await axios.request({
            method: "GET",
            url: "https://finance.yahoo.com/quote/"+symbol+"/key-statistics?.neo_opt=0",
            headers: {
                "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 Safari/537.36"
            }
        })
